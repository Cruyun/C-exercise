...
double F7(double *x)
{
	...
	value = value + (double) rand() /(double)(RAND_MAX) ;
	return value;
}
double F8(double *x)
{
...
void benchmark(struct genotype &pop,int func_num){
    for(int i = 0;i < NP;i++){
        switch(func_num){
            case 1:
                pop.fitness = 1/F1(pop.gene);
                break;
            case 2:
                pop.fitness = 1/F2(pop.gene);
                break;
            case 3:
                pop.fitness = 1/F3(pop.gene);
                break;
            case 4:
                pop.fitness = 1/F4(pop.gene);
                break;
            case 5:
                pop.fitness = 1/F5(pop.gene);
                break;
            case 6:
                pop.fitness = 1/F6(pop.gene);
                break;
            case 7:
                pop.fitness = 1/F7(pop.gene);
                break;
            case 8:
                pop.fitness = 1/F8(pop.gene);
                break;
            case 9:
                pop.fitness = 1/F9(pop.gene);
                break;
            case 10:
                pop.fitness = 1/F10(pop.gene);
                break;
            case 11:
                pop.fitness = 1/F11(pop.gene);
                break;
            case 12:
                pop.fitness = 1/F12(pop.gene);
                break;
            case 13:
                pop.fitness = 1/F13(pop.gene);
                break;
            default:
                break;
